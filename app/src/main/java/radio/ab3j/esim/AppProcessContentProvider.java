...
public class AppProcessContentProvider extends ContentProvider {
    ...
    // $(content read --uri content://esim-cli)
    ...
    public ParcelFileDescriptor openFile(Uri uri, String mode) throws FileNotFoundException {
        ...
        try (OutputStream output = new ParcelFileDescriptor.AutoCloseOutputStream(pipe[1])) {
            ...
            android.util.Log.e("esim-cli", android.util.Log.getStackTraceString(e));
        }

        return pipe[0];
    }

    // $(content query --uri content://esim-cli | tail -n 1)
